...
export default function RestaurantSettings() {
  ...
  return <section className="admin-panel">
    <style>{`
      ...
      .settings-helper { margin:0; color:rgba(255,255,255,0.62); font-size:12px; line-height:1.35; }
    ...
    <div className="admin-card">
      ...
      <div className="settings-grid">
        ...
        <div className="settings-field wide">
          <input className="admin-input" value={form.tablesText} onChange={(e)=>setForm({...form,tablesText:e.target.value})} placeholder="Tables, comma separated"/>
          <p className="settings-helper">Enter table names separated by commas, for example T1, T2, Patio, Takeaway.</p>
        </div>
      </div>
